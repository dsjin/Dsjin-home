...
export default function Home() {
  return (
    <div>
      ...
      <div
        class="flex flex-col justify-around items-center w-full h-screen py-0 lg:py-40 px-4"
      >
        <h1
          class="lg:text-6xl text-4xl"
        >
          About me
        </h1>
        <div
        ...
        >
          <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_o1JRaPxx1E.json"  background="transparent"  speed="1"  class="lg:w-1/5 w-3/5 lg:mr-10" loop autoplay />
          <p
            class="lg:leading-relaxed lg:text-4xl text-2xl indent-12 lg:indent-20 lg:w-2/5"
          >
        ...
        <div
          class="flex justify-around w-full lg:w-2/5"
        >
